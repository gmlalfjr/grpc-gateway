...
// source: pkg/proto/timeline.proto
...
func RegisterTimelineHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TimelineServer) error {
	...
	mux.Handle("POST", pattern_Timeline_CreateTimeline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/main.Timeline/CreateTimeline", runtime.WithHTTPPathPattern("/test"))
		if err != nil {
...
func RegisterTimelineHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TimelineClient) error {
	...
	mux.Handle("POST", pattern_Timeline_CreateTimeline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/main.Timeline/CreateTimeline", runtime.WithHTTPPathPattern("/test"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Timeline_CreateTimeline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"test"}, ""))
)
