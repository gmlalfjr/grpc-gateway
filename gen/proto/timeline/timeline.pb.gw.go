...
/*
Package timeline is a reverse proxy.
...
func request_Timeline_CreateTimeline_0(ctx context.Context, marshaler runtime.Marshaler, client TimelineClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Timeline_CreateTimeline_0(ctx context.Context, marshaler runtime.Marshaler, server TimelineServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq TimelineRequest
	var metadata runtime.ServerMetadata
...
func RegisterTimelineHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TimelineServer) error {
	...
	mux.Handle("POST", pattern_Timeline_CreateTimeline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/main.Timeline/CreateTimeline", runtime.WithHTTPPathPattern("/timeline"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Timeline_CreateTimeline_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Timeline_CreateTimeline_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// "TimelineClient" to call the correct interceptors.
func RegisterTimelineHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TimelineClient) error {
	...
	mux.Handle("POST", pattern_Timeline_CreateTimeline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/main.Timeline/CreateTimeline", runtime.WithHTTPPathPattern("/timeline"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Timeline_CreateTimeline_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Timeline_CreateTimeline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"timeline"}, ""))
)

var (
	forward_Timeline_CreateTimeline_0 = runtime.ForwardResponseMessage
)
